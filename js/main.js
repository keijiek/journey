...
window.addEventListener('DOMContentLoaded',()=>{
  ...
  /**
   * 以下は、ScrollReveal.js 用の設定。
   * head に <script src="https://unpkg.com/scrollreveal"></script> を書いておくこと。
   * 
   * https://scrollrevealjs.org/api/reveal.html を参照し、設定の新設、変更を行う。
   */
  ...
  if(typeof ScrollReveal == 'function') {
    ...
    ScrollReveal().reveal('.jssr_right', {
      origin: 'right',
    });
